...
def classify_movie(title):
    ...
    for keyword in dc_keywords:
        ...
        if keyword in title:
            return 'DC'
    # если в названии нет похожих слов, возвращаем значение Unknown
    return 'Unknown'


# применяем функцию к столбцу с названием Movie
# и создаём новый стоблец Franchise
...
fig = px.scatter(
    ...
    # устанавливаем значение оси y из датасета
    y='IMDB_Score',
    # размер обозначающей фильм точки зависит от продолжительности
    size='RunTime_Min',
